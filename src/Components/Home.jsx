...
function Home() {
  return (
    ...
    <Background class="absolute visible md:invisible" video="../../Home-Page-Banner3.mp4" black="../../black2.webp.jpg" class2="visible md:invisible absolute w-full overflow-hidden opacity-70 "/>
     <Navbar/>
